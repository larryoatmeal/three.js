...
import { Matrix4 } from '../math/Matrix4_wasm.js';
...
import {Object3D as Object3D_wasm, Matrix4 as Matrix4_wasm} from "../../../polygon/polygon.js"
import {PolygonMaster} from "../PolygonMaster.js";
...
function Object3D() {
	...
	console.log("WASM POWERED OBJECT");
	let master = PolygonMasterGlobal;
	console.log(master);

	let object3d_wasm = master.arena.create_object3d();
	let obj = Object3D_wasm.__wrap(object3d_wasm - 4); //WHY??????
	// let obj = Object3D_wasm.new();


	this.obj_wasm = obj;

	// let ptr = obj.get_pointer();
	// console.log("PTR", ptr, "OBJ.PTR", obj.ptr);


	let matrix = Matrix4_wasm.__wrap(obj.get_matrix());
	let matrixWorld = Matrix4_wasm.__wrap(obj.get_matrix_world());
	// console.log(matrix);
...
Object3D.prototype = Object.assign( Object.create( EventDispatcher.prototype ), {
	...
	add: function ( object ) {
		...
		console.log("ADDING");
		console.log(this.obj_wasm, object.obj_wasm);

		this.obj_wasm.add_child(object.obj_wasm);
